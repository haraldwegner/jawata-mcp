...
public final class CureCatalog {
    ...
    private static final Map<String, String> SHIPPED_BUT_UNROUTED = mapOf(
        ...
        "ROUTABLE AND DELIBERATELY NOT ROUTED. `type_code` reports 10 findings over 466 files"
            ...
            + " equally true when it was taken. The corpus is the loaded workspace rather than"
            + " one project, and its growth is mostly this bundle's own source. Every one of"
            + " the ten messages names the SIBLING cure — refactor_to_pattern"
