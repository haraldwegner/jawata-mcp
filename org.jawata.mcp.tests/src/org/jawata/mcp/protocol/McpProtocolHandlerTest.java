...
class McpProtocolHandlerTest {
    ...
    void initialize_returnsServerInfo() throws Exception {
        ...
        assertEquals("JAWATA", result.get("serverInfo").get("name").asText());
    ...
    @Test
    @DisplayName("initialize should carry the protocol-level JAWATA guide (instructions)")
    void initialize_returnsInstructions() throws Exception {
        ...
        assertNotNull(instructions,
            "Sprint 22: the initialize result carries the MCP instructions guide (use JAWATA, not grep)");
