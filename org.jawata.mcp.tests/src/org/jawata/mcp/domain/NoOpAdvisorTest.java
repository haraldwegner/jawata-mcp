...
class NoOpAdvisorTest {
    ...
    @Test
    @DisplayName("JawataService defaults to a NoOpAdvisor when none is supplied")
    void jawataservice_defaults_to_noop() {
        JawataService svc = new JawataService(() -> null, new DetectorCatalog());
